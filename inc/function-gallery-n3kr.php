...
function n3kr_gallery_shortcode($attr) {
	...
	extract(shortcode_atts(array(
		...
		'icontag'    => 'dt',
		'captiontag' => 'dd',
		'link' 		=> 'file', // smart hack -- no effect ??
		'columns'    => 3,
		'size'       => 'thumb-squared',
		'include'    => '',
		'exclude'    => ''
	...
	//	ORIGINAL $link = isset($attr['link']) && 'file' == $attr['link'] ? wp_get_attachment_link($id, $size, false, false) : wp_get_attachment_link($id, $size, true, false);
